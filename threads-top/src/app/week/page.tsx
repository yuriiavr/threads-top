...
import { MessageCircle, Heart, ExternalLink, TrendingUp, Calendar, Trophy, Clock } from 'lucide-react';
...
export default function Top7Page() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-zinc-100 selection:bg-purple-500/20 selection:text-white font-sans antialiased">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] bg-purple-950/20 blur-[130px] rounded-full" />
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-3">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold tracking-tighter text-white">
                TOP<span className="text-zinc-800">.</span><span className="text-purple-500 font-black">WEEK</span>
              </h1>
            </div>
            <div className="flex flex-col md:items-end p-4 rounded-xl bg-zinc-900/20 border border-zinc-800/30 backdrop-blur-sm">
              ...
              <p className="text-lg font-mono text-zinc-300 font-medium">Last 7 Days</p>
            </div>
          </div>

          <nav className="flex flex-wrap gap-3">
            <Link href="/" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-purple-500/50 hover:bg-zinc-800/50 transition-all text-sm font-medium text-zinc-400 hover:text-purple-400">
              <Clock size={16} />
              Головна
            </Link>
            <Link href="/hall-of-fame" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-purple-500/50 hover:bg-zinc-800/50 transition-all text-sm font-medium text-zinc-400 hover:text-purple-400">
              <Trophy size={16} />
              Зал слави
            </Link>
          </nav>
      ...
      <main className="relative max-w-4xl mx-auto px-6 pb-32">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40 space-y-6">
            <div className="w-10 h-10 border-2 border-zinc-800 border-t-purple-500 rounded-full animate-spin" />
          ...
          <div className="space-y-3">
            {posts.map((post, index) => (
              ...
              >
                ...
                <div className="relative p-6 md:p-7 bg-[#080808] border border-zinc-900 rounded-2xl flex gap-6 items-start transition-colors duration-300 group-hover:bg-[#0a0a0a] group-hover:border-zinc-800/80 group-hover:shadow-2xl group-hover:shadow-purple-500/5">
                  <div className="flex flex-col items-center pt-1 width-[40px] flex-shrink-0">
                    <span className="text-xl font-bold font-mono text-zinc-800 group-hover:text-purple-900 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:border-purple-800/50 transition-colors text-xs font-bold text-zinc-400 group-hover:text-purple-200 uppercase">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1.5 p-1.5 px-2.5 rounded-full bg-zinc-900/50 border border-zinc-800 opacity-60 group-hover:opacity-100 group-hover:border-purple-900 group-hover:bg-purple-950/20 transition-all">
                          <span className="text-[10px] font-bold text-zinc-500 group-hover:text-purple-300">OPEN</span>
                          <ExternalLink size={13} className="text-zinc-600 group-hover:text-purple-400" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 border-t border-zinc-900/80 pt-5 mt-auto">
                      ...
                      <div className="flex items-center gap-2.5 group/stat">
                        <MessageCircle size={18} className="text-zinc-700 group-hover/stat:text-purple-400 transition-colors" />
                        <span className="text-sm font-semibold font-mono text-zinc-500 group-hover/stat:text-purple-200">{formatCount(post.reply_count)}</span>
                      </div>
                    </div>
                  </div>
                </div>
